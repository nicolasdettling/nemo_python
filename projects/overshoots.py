...
suites_by_scenario = {'piControl' : ['cs495'],
                      ...
                      '3K_ramp_down' : ['db223', 'dc032', 'dc249', 'df453', 'de620', 'df028', 'de621'],  #TODO add these back in after single copy unavailable fixed , 'df021', 'df023'],
                      '4K_stabilise' : ['cz376','db723','db733'],
                      '4K_ramp_down' : ['da892', 'dc123', 'dd210', 'dh541', 'dh859'],
